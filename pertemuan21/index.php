...
<head>
    ...
    <style>
        ...
        .loader {
            display: block;
            margin-left: 10px; /* Menambahkan jarak antara tombol cari dan GIF */
            width: 50px; /* Atur ukuran GIF sesuai keinginan */
            height: 50px;
            display: none;
        }
...
<body>
    ...
    <div class="center-container">
        ...
        <!-- target blank untuk membuka halaman baru  dan tidak menimpa halaman index-->
    </div>
